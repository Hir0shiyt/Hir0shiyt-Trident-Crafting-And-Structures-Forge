...
public class TridentstickItem extends TridentCraftingAndStructuresModElements.ModElement {
	@ObjectHolder("trident_crafting_and_structures:tridentstick")
	public static final Item block = null;

	public TridentstickItem(TridentCraftingAndStructuresModElements instance) {
		super(instance, 14);
	}
