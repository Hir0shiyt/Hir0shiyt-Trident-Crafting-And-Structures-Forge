...
public class FallinggianttridentstructureStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("trident_crafting_and_structures", "giant_trident_structure_2.0"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("fallinggianttridentstructure"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
					new ResourceLocation("trident_crafting_and_structures:fallinggianttridentstructure"), configuredFeature);
		}
	}
