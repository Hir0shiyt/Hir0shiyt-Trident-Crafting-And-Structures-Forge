...
public class MutatedGiantFallingTridentStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 700) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager().getTemplateDefaulted(
									new ResourceLocation("trident_crafting_and_structures", "mutated_giant_falling_trident_2.0"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("mutated_giant_falling_trident"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE,
					new ResourceLocation("trident_crafting_and_structures:mutated_giant_falling_trident"), configuredFeature);
		}
	}
